package com.pikachu.gateway.outbound.httpclient4;
...
import com.pikachu.gateway.router.RandomHttpEndpointRouter;
...
public class HttpOutboundHandler {
    ...
    private void fetchGet(final FullHttpRequest inbound, final ChannelHandlerContext ctx, final String url) {
        ...
        httpGet.setHeader("pikachu", inbound.headers().get("pikachu"));
